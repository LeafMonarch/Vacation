...
<body>
	...
	<table align="center" class="">
		<th class="text-center font-sans-serif font-bold text-white text-2xl p-5">Malaysia</th>
		<tr>
			<td>
		...
		<th class="text-center font-sans-serif font-bold text-white text-2xl p-5">Canada</th>
		<tr>
			<td>
		...
		<th class="text-center font-sans-serif font-bold text-white text-2xl p-5">France</th>
		<tr>
			<td>
		...
		<th class="text-center font-sans-serif font-bold text-white text-2xl p-5">Ireland</th>
		<tr>
			<td>
		...
		<th class="text-center font-sans-serif font-bold text-white text-2xl p-5">Australia</th>
		<tr>
			<td>
